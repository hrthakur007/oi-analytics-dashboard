...
function updateDashboard(spotData, oiData, timeString) {
  ...
  sentimentBadge.className = `card-badge ${sentimentClass}`;
  sentimentPointer.style.left = `${pointerLeftPct}%`;

  // 5.5. Render Multi-Strike Vertical OI Chart (ATM Centered)
  renderVerticalChart(selectedOI, atmStrike);

  // 5.6. Render Volume Bar Chart
